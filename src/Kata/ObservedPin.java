...
// they never finally lock the system or sound the alarm. That's why we can try out
// all possible (*) variations.
//
//* possible in sense of: the observed PIN itself and all variations considering the adjacent digits
//
//Can you help us find all those variations? It would be nice to have a function, that returns
// an array (or a list in Java/Kotlin and C#) of all variations for an observed PIN
...
public class ObservedPin {
    public static final Map<Character, String> ADJACENTS = new HashMap<>() {{
        put('1', "124");
        put('2', "2135");
        put('3', "326");
        put('4', "4157");
